...
import 'package:pose_detection/core/presentation/pages/capture_page.dart';
import 'package:pose_detection/core/presentation/pages/session_details_page.dart';
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF4AE6D7).withValues(alpha: 0.15),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Image.asset(
                    'assets/logo.png',
